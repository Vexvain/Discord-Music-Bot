...
If this is running then python is installed, but we must make sure that python3 is installed.
...
Remember to make sure the user knows the script; might prompt for pass
